...
SERVER_URL = "http://server5-service:8080/data"
...
def send_request():
    """Šalje POST zahtjev prema serveru s generiranim podacima."""
    try:
        data = generisi_weather_podatke()
        print("Slanje podataka:", json.dumps(data, indent=2))
...
if __name__ == "__main__":
    print(f"Početak slanja zahtjeva prema serveru na svakih {WAIT_INTERVAL} sekundi...")
    while True:
        send_request()
